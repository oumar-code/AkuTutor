# AkuTutor Onboarding Checklist

Use this checklist to get started with AkuTutor.
...
- [ ] Enter the directory: `cd AkuTutor`
...
## 6. Build & Run
- [ ] Build Docker image: `docker build -t akututor:latest .`
- [ ] Run locally: `npm run dev` or `npm start`
- [ ] Or run with Docker: `docker run -p 8080:8080 akututor:latest`
